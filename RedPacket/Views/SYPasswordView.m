...
- (void)initPwdTextField
{
    ...
    for (int i = 0; i < kDotCount - 1; i++) {
        ...
        lineView.backgroundColor = [UIColor colorWithRed:129/255.0 green:206/255.0 blue:242/255.0 alpha:1];
...
- (UITextField *)textField
{
    if (!_textField) {
        ...
        _textField.layer.borderColor = [[UIColor colorWithRed:129/255.0 green:206/255.0 blue:242/255.0 alpha:1] CGColor];
